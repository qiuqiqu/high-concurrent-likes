...
public class ThumbServiceRedisImpl extends ServiceImpl<ThumbMapper, Thumb>
    ...
    public ThumbServiceRedisImpl(UserService userService, BlogService blogService, TransactionTemplate transactionTemplate, RedisTemplate<String, Object> redisTemplate) {
